...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parchment = __webpack_require__(25);
	...
	icons['undo'] = __webpack_require__(11);
	icons['redo'] = __webpack_require__(12);
	...
	function makeEditor(textarea) {
	  ...
	  (0, _utils.addButton)(options, "video") + (0, _utils.addButton)(options, "divider") + '</span>' +
	  ...
	  options.modules.toolbar.handlers = options.modules.toolbar.handlers || {
	    ...
	    showcode: function showcode() {
	      ...
	      if (textarea.style.display == 'none') {
	        ...
	        this.quill.disable();
	        textarea.value = editorHtml; // textarea.value = pretty(editorHtml);
	      } else {
